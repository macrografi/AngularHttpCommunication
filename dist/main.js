...
/* harmony import */ var app_core_books_resolver_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! app/core/books-resolver.service */ 349);
...
const routes = [
    { path: 'dashboard', component: app_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_2__.DashboardComponent, resolve: { resolvedBook: app_core_books_resolver_service__WEBPACK_IMPORTED_MODULE_5__.BooksResolverService } },
...
AppModule = (0,tslib__WEBPACK_IMPORTED_MODULE_8__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_9__.NgModule)({
        ...
        providers: [{ provide: _angular_core__WEBPACK_IMPORTED_MODULE_9__.ErrorHandler, useClass: _core_book_tracker_error_handler_service__WEBPACK_IMPORTED_MODULE_7__.BookTrackerErrorHandlerService }],
...
let DataService = class DataService {
    ...
    getAllBooks() {
        ...
        return this.http.get('/api/books').pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.catchError)((err) => this.handleHttpError(err)));
    }
...
let DashboardComponent = class DashboardComponent {
    ...
    ngOnInit() {
        const resolvedData = this.route.snapshot.data['resolvedBook'];
...
const allBooks = [
    ...
    { bookID: 6, title: 'Alices Adventures in Wonderland', author: 'Lewis Carroll', publicationYear: 1865 },
];
...
let EditBookComponent = class EditBookComponent {
    ...
    saveChanges() {
        this.dataService.updateBook(this.selectedBook).subscribe((data) => console.log(`${this.selectedBook.title} update successfully`), (err) => console.log(err));
    }
};
